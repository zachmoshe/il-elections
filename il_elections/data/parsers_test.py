...
# NOTICE: Order of hebrew fields is reversed.
# For example, in the first row ירושלים is the 3rd column.
...
_CSV_VOTES_FILE_RECORDS_FILE1 = [
    {'ballot_id': '159.0', 'locality_id': '7100', 'locality_name': 'אשקלון',
     'num_registered_voters': 612,
     'num_voted': 455, 'num_disqualified': 0, 'num_approved': 455,
     'parties_votes': {
         'p.z': 0, 'vdAm.': 0, 'mHl': 189, 'r': 0, 'ir': 0, 'mrZ': 7, 'k': 0, 't': 20, 'rK': 0,
         'n': 0, 'ni': 0, 'rp.': 0, 'KZ.': 0, 'iK': 0, 'ip.': 0, 'Zp.': 0, 'Ss': 41, 'K': 0,
         'b': 37, 'iz': 5, 'nr': 0, 'rn': 1, 'Z.': 0, 'g': 1, 'kk.': 0, 'z': 0, 'amT': 11, 'Zi': 0,
         'i': 0, 'l': 26, 'T': 30, 'Zk': 0, 'zZ.': 0, 'ph': 65, 'Kk.': 0, 'kn.': 22, 'in': 0,
         'Am.': 0, 'Ki': 0}},
    {'ballot_id': '1.0', 'locality_id': '2008', 'locality_name': 'שדה יצחק',
     'num_registered_voters': 426,
     'num_voted': 292, 'num_disqualified': 0, 'num_approved': 292,
     'parties_votes': {
         'p.z': 0, 'vdAm.': 1, 'mHl': 59, 'r': 2, 'ir': 0, 'mrZ': 22, 'k': 0, 't': 4, 'rK': 0,
         'n': 0, 'ni': 0, 'rp.': 0, 'KZ.': 0, 'iK': 0, 'ip.': 0, 'Zp.': 0, 'Ss': 5, 'K': 0,
         'b': 13, 'iz': 2, 'nr': 0, 'rn': 0, 'Z.': 1, 'g': 0, 'kk.': 0, 'z': 0, 'amT': 35, 'Zi': 0,
         'i': 0, 'l': 13, 'T': 15, 'Zk': 0, 'zZ.': 0, 'ph': 77, 'Kk.': 0, 'kn.': 43, 'in': 0,
         'Am.': 0, 'Ki': 0}},
    {'ballot_id': '260.1', 'locality_id': '9000', 'locality_name': 'באר שבע',
     'num_registered_voters': 564,
     'num_voted': 405, 'num_disqualified': 1, 'num_approved': 404,
     'parties_votes': {
         'p.z': 0, 'vdAm.': 3, 'mHl': 170, 'r': 2, 'ir': 0, 'mrZ': 8, 'k': 0, 't': 23, 'rK': 0,
         'n': 0, 'ni': 0, 'rp.': 0, 'KZ.': 0, 'iK': 0, 'ip.': 0, 'Zp.': 0, 'Ss': 13, 'K': 0,
         'b': 47, 'iz': 4, 'nr': 0, 'rn': 0, 'Z.': 0, 'g': 0, 'kk.': 0, 'z': 0, 'amT': 13, 'Zi': 0,
         'i': 0, 'l': 5, 'T': 25, 'Zk': 0, 'zZ.': 0, 'ph': 56, 'Kk.': 0, 'kn.': 30, 'in': 0,
         'Am.': 5, 'Ki': 0}},
]
_CSV_VOTES_FILE_RECORDS_FILE2 = [
    {'ballot_id': '164.0', 'locality_id': '6100', 'locality_name': 'בני ברק',
     'num_registered_voters': 694,
     'num_voted': 579, 'num_disqualified': 15, 'num_approved': 564,
     'parties_votes': {
         'ph': 1, 'mHl': 3, 'k.K': 0, 'mrZ': 0, 'g': 447, 'Kp.': 0, 'zi': 0, 'Ki': 0, 'p.n': 0,
         'nk.': 0, 'zZ.': 0, 'iz': 0, 'amT': 0, 'Z.i': 0, 'p.k.': 0, 'Z.': 0, 'n.n': 0, 'ZK': 1,
         'iZ.': 0, 'n.': 0, 'Ss': 106, 'nr': 0, 'k': 0, 'r': 0, 'zn': 0, 'z': 0, 'p.z': 0, 'nZ.': 0,
         'Kn.': 0, 'p.Z.': 0, 'K': 0, 'Z.z': 0, 'p.i': 0, 'in.': 0, 'zk.': 0, 'n.k.': 0, 'i': 0,
         'n': 0, 'vm.': 0, 'l': 0, 'dAm.': 0, 'nz': 0, 'tb': 6}},
]
...
class BallotsVotesCSVParserTest(unittest.TestCase):
    ...
    def test_parses_file_correctly(self, _, path_str, expected_records):
        results = parsers.BallotsVotesFileParser(
            format_name='csv', encoding='cp1255').parse(pathlib.Path(path_str))
